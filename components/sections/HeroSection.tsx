...
function MobileHero({ ctaRef }: { ctaRef: React.RefObject<HTMLDivElement | null> }) {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'url(/images/2.jpeg)', backgroundPosition: 'center 20%', zIndex: 1 }}
      aria-hidden="true"
    />
  )
}
    ...
    <section id="hero" className="relative">
      <div className="hero-inner relative w-full" style={{ willChange: 'transform', transform: 'translateZ(0)' }}>
        ...
        <div
          ...
          className="absolute right-1/2 translate-x-1/2 flex flex-col items-center gap-2 text-silver/40 hidden sm:flex"
